...
\usepackage[left=3cm,top=2cm,right=1.5cm,bottom=2cm]{geometry} % (2) -- стандарт
% \usepackage[left=2.7cm,top=1.3cm,right=1.2cm,bottom=1.2cm]{geometry} % (3)
% \usepackage[left=2.8cm,top=1.3cm,right=1.0cm,bottom=1.0cm]{geometry} % (4) -- robocopy в 4 общаге
